...
import com.fawaz.notesapp.data.NoteRepository
import com.fawaz.notesapp.data.entity.Notes
import com.fawaz.notesapp.data.room.NotesDatabase
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.launch

class NotesViewModel(application: Application): AndroidViewModel(application) {
    private val notesDao = NotesDatabase.getDatabase(application).notesDao()
    private val repository: NoteRepository = NoteRepository(notesDao)
